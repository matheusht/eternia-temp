...
const Index = () => {
  ...
  if (authLoading || profileLoading) {
    return (
      <div className="min-h-screen bg-gradient-mystic flex items-center justify-center">
        <div className="text-foreground text-xl font-cinzel">Carregando a magia celestial...</div>
      </div>
    );
  }
  ...
  if (!profile?.birth_date || !profile?.birth_time || !profile?.birth_location || !profile?.display_name) {
