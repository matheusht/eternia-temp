        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-playfair ethereal-text">{t('weeklyReport.title')}</h1>
          ...
          <div className="grid gap-6">
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">{t('weeklyReport.spiritualPoints')}</p>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-primary mb-2">
                      {weeklyStats.dailyVisits}
                    </div>
                    <p className="text-sm text-muted-foreground">{t('weeklyReport.visitsThisWeek')}</p>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-primary mb-2">
                      {spiritualProgress.level}
                    </div>
                    <p className="text-sm text-muted-foreground">{t('weeklyReport.currentLevel')}</p>
                  </div>
                </div>

                <div className="mt-6">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium">{t('weeklyReport.levelProgress')} {spiritualProgress.level}</span>
                    <span className="text-sm text-muted-foreground">
                      {spiritualProgress.progress}{t('weeklyReport.progressTo')} {spiritualProgress.nextLevel}
                    </span>
                  </div>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 rounded-lg bg-primary/5">
                    ...
                    <p className="text-xs text-muted-foreground">{t('weeklyReport.aiConsultations')}</p>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-primary/5">
                    <div className="text-2xl font-bold text-primary mb-1">
                      {weeklyStats.diaryEntries}
                    </div>
                    <p className="text-xs text-muted-foreground">{t('weeklyReport.diaryEntries')}</p>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-primary/5">
                    <div className="text-2xl font-bold text-primary mb-1">
                      {weeklyStats.dailyVisits}
                    </div>
                    <p className="text-xs text-muted-foreground">{t('weeklyReport.dailyVisits')}</p>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-primary/5">
                    <div className="text-2xl font-bold text-primary mb-1">
                      {spiritualProgress.level}
                    </div>
                    <p className="text-xs text-muted-foreground">{t('weeklyReport.spiritualLevel')}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mystic-border cosmic-glow">
              <CardHeader>
                <CardTitle className="text-center">{t('weeklyReport.weeklySpiritualInsight')}</CardTitle>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center p-4 rounded-lg bg-gradient-cosmic/10">
                    <h4 className="font-medium mb-2">{t('weeklyReport.spiritualFocus')}</h4>
                    <p className="text-sm text-muted-foreground">Connection with nature</p>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-gradient-cosmic/10">
                    <h4 className="font-medium mb-2">{t('weeklyReport.recommendedRitual')}</h4>
                    <p className="text-sm text-muted-foreground">Full moon bath</p>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-gradient-cosmic/10">
                    <h4 className="font-medium mb-2">{t('weeklyReport.dominantEnergy')}</h4>
